...
def configure(keymap):
    ...
    def recenter():
        ...
        if checkWindow("idea64.exe",""): # IntelliJ IDEA
            self_insert_command("C-l")()
        if checkWindow("pycharm.exe",""): # pycharm
            self_insert_command("C-m")()
    ...
    ## ime
    define_key(keymap_emacs, "C-o", ime_on)
    define_key(keymap_emacs, "C-i", ime_off)
